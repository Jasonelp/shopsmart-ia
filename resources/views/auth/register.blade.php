            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="flex items-center justify-center px-4 py-3 bg-green-600 text-white rounded-lg cursor-pointer font-semibold shadow-md">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
                            </svg>
                            <input type="radio" name="tipo_cuenta" value="cliente" class="sr-only" checked>
                            Cliente
                        </label>
                        <label class="flex items-center justify-center px-4 py-3 bg-gray-200 text-gray-700 rounded-lg cursor-pointer font-semibold hover:bg-gray-300 transition">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
                                <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd" />
                            </svg>
                            <input type="radio" name="tipo_cuenta" value="vendedor" class="sr-only">
                            Vendedor
                        </label>
                    </div>
                </div>
